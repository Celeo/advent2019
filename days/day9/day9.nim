...
proc loadMachine(codes: seq[int]): Machine =
  ## Load a sequence of instruction codes into a new machine object.
  ##
  ## This processing takes into account the requirement for memory padding.
